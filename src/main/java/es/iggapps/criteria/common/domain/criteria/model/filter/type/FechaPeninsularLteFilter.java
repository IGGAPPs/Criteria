...
public final class FechaPeninsularLteFilter extends Filter<FechaPeninsular> {

  public static final Schema TYPE = Schema.FECHA_PENINSULAR_LTE;
  ...
  private FechaPeninsularLteFilter(final Field field, final List<PlainFilter> plainFilterList) {
  ...
  public static Filter<FechaPeninsular> of(final Field field,
    ...
    return new FechaPeninsularLteFilter(field, plainFilterList);
  }
