...
class CodigoPaisContainsAllIntegrationTest {
  ...
  void givenValid3DigitCodes_whenValidate_thenNoException() {
    Criteria criteria = factory.make(
        Optional.of("paises:CONTAINS_ALL:[123,456,789]"),
        Optional.empty(),
        Optional.empty(),
        Optional.empty()
    );
    ...
    List<String> values = filter.withOperator(Operator.CONTAINS_ALL).get();
  ...
  void givenCodesWithWrongLength_whenValidate_thenBadRequestException() {
    Criteria criteria = factory.make(
        Optional.of("paises:CONTAINS_ALL:[12,1234,123]"),
        Optional.empty(),
        Optional.empty(),
        Optional.empty()
    );
  ...
  void givenCodeWithLetters_whenValidate_thenBadRequestException() {
    Criteria criteria = factory.make(
        Optional.of("paises:CONTAINS_ALL:[12a,456]"),
        Optional.empty(),
        Optional.empty(),
        Optional.empty()
    );
  ...
  void givenSingleValidCode_whenValidate_thenNoException() {
    Criteria criteria = factory.make(
        Optional.of("paises:CONTAINS_ALL:[007]"),
        Optional.empty(),
        Optional.empty(),
        Optional.empty()
    );
